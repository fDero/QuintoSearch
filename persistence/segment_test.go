...
func TestAddToEmptySegment(t *testing.T) {
	segment := newSegment()
	tracker := misc.TermTracker{DocumentId: 1, Position: 2}
	segment.add(tracker)
...
func TestAddToNonEmptySegment(t *testing.T) {
	segment := newSegment()
	tracker := misc.TermTracker{DocumentId: 1, Position: 2}
	tracker2 := misc.TermTracker{DocumentId: 50, Position: 2}
	segment.add(tracker)
...
func TestAddInTheMiddleOfSegment(t *testing.T) {
	segment := newSegment()
	tracker := misc.TermTracker{DocumentId: 1, Position: 2}
	tracker3 := misc.TermTracker{DocumentId: 50, Position: 2}
	tracker2 := misc.TermTracker{DocumentId: 25, Position: 2}
	segment.add(tracker)
